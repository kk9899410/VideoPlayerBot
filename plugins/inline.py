...
buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/AnimeSubbingTeam07"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/AnimeSubbingTeam07"),
            ],
            [
                InlineKeyboardButton("🤖 contact to sakata 🤖", url="https://www.google.com"),
            ]
         ]
    ...
    if query.query == "SAF_ONE":
        answers.append(
            InlineQueryResultArticle(
                ...
                input_message_content=InputTextMessageContent(f"{REPLY_MESSAGE}\n\n<b>© Powered By : \n@India_CBI_Offical | @India_CBI_Offical 👑</b>", disable_web_page_preview=True),
